package Net::WolframAlpha::Warnings;
...
use Net::WolframAlpha::Spellcheck;
...
sub new {
	...
	if (defined $spellchecks) {
		...
		push(@{$self->{'spellcheck'}}, Net::WolframAlpha::Spellcheck->new($spellcheck));
	    }
	}
    }
...
Net::WolframAlpha::Warnings - Perl object returned via $wa->(?:validate|)query->warnings
...
$warnings->spellcheck - array of L<Net::WolframAlpha::Spellcheck> elements

package Net::WolframAlpha::ValidateQuery;
...
Net::WolframAlpha::ValidateQuery - Perl object returned via $wa->validatequery
...
$validatequery->error - 0 or L<Net::WolframAlpha::Error>, tells whether there was an error or not

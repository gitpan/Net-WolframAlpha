package Net::WolframAlpha::Sources;
...
sub new {
	...
	if (defined $source) {
		...
		push(@{$self->{'source'}}, Net::WolframAlpha::Source->new($value));
	    }
	}
    }
...
Net::WolframAlpha::Sources - Perl object returned via $query->sources
...
$sources->source - array of L<Net::WolframAlpha::Source> elements

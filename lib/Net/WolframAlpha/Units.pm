package Net::WolframAlpha::Units;
...
sub new {
	...
	if (defined $unit) {
		...
		push(@{$self->{'unit'}}, Net::WolframAlpha::Unit->new($value));
	    }
	}
...
Net::WolframAlpha::Units - Perl objects returned via $info->units
...
$units->unit - array of L<Net::WolframAlpha::Unit> elements

package Net::WolframAlpha::Didyoumeans;
...
use Net::WolframAlpha::Didyoumean;
...
sub new {
	...
	if (defined $didyoumean) {
		...
		push(@{$self->{'didyoumean'}}, Net::WolframAlpha::Didyoumean->new($value));
	    }
	}
    }
...
Net::WolframAlpha::Didyoumeans - Perl objects returned via $query->didyoumeans
...
$didyoumeans->didyoumean - array of L<Net::WolframAlpha::Didyoumean> objects

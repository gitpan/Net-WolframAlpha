package Net::WolframAlpha::Assumptions;
...
use Net::WolframAlpha::Assumption;
...
sub new {
	...
	if (defined $assumption) {
		...
		push(@{$self->{'assumption'}}, Net::WolframAlpha::Assumption->new($value));
	    }
	}
    }
...
Net::WolframAlpha::Assumptions - Perl object returned via $wa->(?:validate|)query->assumptions
...
$assumptions->assumption - array of L<Net::WolframAlpha::Assumption> elements
